...
const ProviderList = ({
  ...
  const getKYCText = (rating: string) => {
    const texts: { [key: string]: string } = {
      ...
      B: "This exchange refunds transactions that fail their AML check. In very rare cases funds may be blocked if a legal order demands it or stolen coins are involved. Past history at GhostSwap is very good.",
    ...
    <div className="w-full bg-[#0a1a1e]/90 backdrop-blur-md rounded-2xl p-2 md:p-6 shadow-2xl border border-cyan-500/30 max-h-[800px] md:max-h-[800px] flex flex-col">
      ...
      <div className="text-center mb-1 md:mb-2 flex-shrink-0">
        ...
        {/* <p className="text-gray-400 text-xs md:text-sm">
          All transactions are covered by the GhostSwap Guarantee
        </p> */}
      </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs">
                      ...
                      history at GhostSwap is very good.
                    </p>
                  </div>
