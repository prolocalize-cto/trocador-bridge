      ...
      <div className="relative z-0 bg-[#143157] flex flex-col lg:grid lg:grid-cols-[55%_45%] gap-4 overflow-hidden rounded-3xl">
        ...
        <div className="flex flex-col order-1 lg:order-none p-5 sm:p-6 lg:p-8 justify-between gap-4 lg:gap-8">
          <span className="text-xl font-medium text-center lg:text-left lg:text-2xl xl:text-3xl text-white">
            Help us improve ChangeHero and get a zero-fee crypto exchange
          </span>

          <div className="flex flex-col gap-8 lg:flex-row lg:gap-6 lg:items-center">
            <button className="inline-flex items-center justify-center gap-1.5 whitespace-nowrap select-none transition-colors disabled:pointer-events-none disabled:opacity-40 shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-white/50 bg-white/10 hover:bg-white/20 h-12 py-2 rounded-full mx-auto lg:mx-0 order-2 lg:order-none w-fit text-white text-xl font-semibold px-8">
              Take the survey
            </button>
